...
<!-- Проверяемый список для ЭТОГО блока: тесты зелёные, покрытие не ниже прошлой приёмки, статические проверки проекта зелёные, смоук флоу блока пройден фактически, документация блока обновлена, интеграция с зависимыми блоками не сломана. -->
