...
<!-- Проверяемый список для ЭТОГО блока: тесты зелёные (покрытие ≥80%), смоук флоу блока пройден фактически, документация блока обновлена, интеграция с зависимыми блоками не сломана. -->
